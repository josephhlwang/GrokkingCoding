...
def ans_caller(root, sequence):
    return ans(root, sequence, 0)
...
def find_current_path(currentNode, sequence):
    ...
    if currentNode.val != sequence[0]:
        ...
        if currentNode.left is None and currentNode.right is None:
            ...
            del sequence[0]
            return find_current_path(currentNode.left, sequence) or find_current_path(
...
def main():
    ...
    print("Tree has path sequence: " + str(ans_caller(root, [1, 0, 7])))
    print("Tree has path sequence: " + str(ans_caller(root, [1, 1, 6])))
