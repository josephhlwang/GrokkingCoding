...
def main():
    print(
        ...
        + str(ans([Meeting(4, 5), Meeting(2, 3), Meeting(2, 4), Meeting(3, 5)]))
    )
    print(
        "Minimum meeting rooms required: "
        + str(ans([Meeting(1, 4), Meeting(2, 5), Meeting(7, 9)]))
    )
    print(
        "Minimum meeting rooms required: "
        + str(ans([Meeting(6, 7), Meeting(2, 4), Meeting(8, 12)]))
    )
    print(
        "Minimum meeting rooms required: "
        + str(ans([Meeting(1, 4), Meeting(2, 3), Meeting(3, 6)]))
    )
    print(
        "Minimum meeting rooms required: "
        + str(ans([Meeting(4, 5), Meeting(2, 3), Meeting(2, 4), Meeting(3, 5)]))
