...
def main():
    print("Can attend all appointments: " + str(ans([[1, 4], [2, 5], [7, 9]])))
    print("Can attend all appointments: " + str(ans([[6, 7], [2, 4], [8, 12]])))
    print("Can attend all appointments: " + str(ans([[4, 5], [2, 3], [3, 6]])))
