...
def main():
    ...
    for i in ans([interval(1, 4), interval(2, 5), interval(7, 9)]):
        i.print_interval()
    print()

    print("Merged intervals: ", end="")
    for i in ans([interval(6, 7), interval(2, 4), interval(5, 9)]):
        i.print_interval()
    print()

    print("Merged intervals: ", end="")
    for i in ans([interval(1, 4), interval(2, 6), interval(3, 5)]):
        i.print_interval()
    print()
