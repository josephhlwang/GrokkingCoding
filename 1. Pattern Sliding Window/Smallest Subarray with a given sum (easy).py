...
def main():
    print("Smallest subarray length: " + str(ans(7, [2, 1, 5, 2, 3, 2])))
    print("Smallest subarray length: " + str(ans(7, [2, 1, 5, 2, 8])))
    print("Smallest subarray length: " + str(ans(8, [3, 4, 1, 1, 6])))
