...
def main():
    print("Length of the longest substring: " + str(ans("aabccbb")))
    print("Length of the longest substring: " + str(ans("abbbb")))
    print("Length of the longest substring: " + str(ans("abccde")))
